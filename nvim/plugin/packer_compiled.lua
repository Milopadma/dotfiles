...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    config = { "\27LJ\2\n]\0\0\4\0\6\0\t6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\4\0005\3\3\0=\3\5\2B\0\2\1K\0\1\0\vkeymap\1\0\0\1\0\1\vaccept\f<S-Tab>\nsetup\fcopilot\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/Users/mylo/.local/share/nvim/site/pack/packer/opt/copilot.vim",
  ...
  ["nvim-lspconfig"] = {
    after = { "null-ls.nvim", "lsp-zero.nvim" },
